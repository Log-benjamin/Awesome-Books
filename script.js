...
class CreateBookList {
  ...
  static createContactSection() {
    ...
    contactInfo.innerHTML = `
        ...
        <ul>
            <li>Our-email: Binyam - <a>binyampowerhc@gmail.com</a>,  Iwu - <a>iwuconcept@gmail.com</a></li>
            <li>Our Phone number: Binyam - +251 9 13 80 58 37,  Iwu - +234 907 525 1287</li>
            <li>Our address Streetname: 4 Obaze str, Abuja quaters, G.R.A, Benin city,Edo state.</li>
        </ul>
    `;
